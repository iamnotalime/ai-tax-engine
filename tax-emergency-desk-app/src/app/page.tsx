    ...
    <>
      ...
      <main className="shell">
        <section className="hero">
          <div className="stack">
            ...
            <div className="actions">
              <Link className="button primary" href="/cases/new"><UploadCloud size={18} aria-hidden="true" /> Upload dokumen</Link>
              <Link className="button" href="/login"><LogIn size={18} aria-hidden="true" /> Login</Link>
            </div>
            <div className="disclaimer">{FREE_SCAN_DISCLAIMER}</div>
          </div>
          <aside className="hero-card">
            <p className="eyebrow case-preview-eyebrow">Case file preview</p>
            <h2 className="case-preview-title">SP2DK clarity desk</h2>
        ...
        <section className="section grid">
          ...
          <div className="card"><h3>2. AI workflow teraudit</h3><p className="muted">OCR, klasifikasi, extraction, evidence checklist, draft, dan support check.</p></div>
